...
public class SentenceTest {
    ...
    @Before
    public void init() {
        String testString = "Во время наследования возможно изменения модификаторов доступа в сторону большей видимости;.";
    ...
    public void swapListElements() throws Exception {
        String testString = "видимости время наследования возможно изменения модификаторов доступа в сторону большей Во;.";
